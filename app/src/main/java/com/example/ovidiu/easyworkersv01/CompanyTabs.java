...
public class CompanyTabs extends AppCompatActivity {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new ApplicationsTab(), "Applications");
        adapter.addFragment(new PostedJobsTabs(), "Jobs Posted");
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_company_tabs, menu);
        return true;
    }
